...
public:
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "OCaml Qt JSON Demo", nullptr));
        inputLine->setPlaceholderText(QCoreApplication::translate("MainWindow", "Entrez un message ou /time /add ...", nullptr));
