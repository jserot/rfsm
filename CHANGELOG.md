...
* The name of the testbench (resp. toplevel) modules generated by the VHDL backend is now `xxx_tb`
  (resp. `xxx_top`), where `xxx` is the name of the last source file (typically: `main`)
