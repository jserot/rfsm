...
\medskip \textbf{Note}. The \verb|-normalize| option of the \texttt{rfsmc} compiler allows to
automatically transform a Moore-style description into a Mealy-style one. This option is
